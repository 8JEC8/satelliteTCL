    ...
    while True:
        try:
            ...
            if command == ".RSSI":
                ...
                filename="/sd/"+arg
                print_message(is_sending=0, message=og_data)
                telem = "RES_COM -> Solicitando conversión de imagen"
                algorithmBase64.convert_image_to_base64(filename, "/sd/image.b64")
                telem = "RES_COM -> Imagen convertida a base64"
                print_message(is_sending=2, message=telem)
